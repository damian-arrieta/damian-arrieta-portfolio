            ...
            <div className="row">
                <div className="col-12">
                    <div className="aboutme-bx wow zoomIn">
                        ...
                        <br /><br />
                        Fuera del trabajo disfruto de mi pasatiempo favorito: la música. Estoy comprometido con mantener una vida sana, lo que me permite un equilibrio personal y profesional que considero esencial para el desempeño óptimo en cualquier ámbito.
                      </p>
                    </div>
                </div>
            </div>
